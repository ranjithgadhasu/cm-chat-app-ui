  ...
  return (
   <>
    <div className="app-page min-h-screen flex h-screen bg-[#F4F5F8] dark:bg-[#0b141a]">
         <Sidebar />
      {/* Last Seen Panel */}
      <div className="w-[320px] min-w-[250px] border-r border-[#E2E5EC] dark:border-gray-700 bg-[#F4F5F8] dark:bg-[#0b141a] flex flex-col h-full">
        {/* Header */}
          ...
          {options.map((option, index) => (
            <div key={option}>
              ...
              {index !== options.length - 1 && (
                <div className="ml-[38px] mr-8 border-b border-[#D8DCE5] dark:border-gray-700 " />
              )}
            </div>
          ))}
        </div>
